#!/usr/bin/env python3
"""Pool=True, UNKNOWN + MIXED labels, bs=10/20/40"""
...
OUTDIR = "expdata/pool_unknown_mixed"
...
for BS in [10, 20, 40]:
    ...
    print(f"\n{'='*60}\nResults (bs={BS}, Pool=True, UNKNOWN+MIXED):")

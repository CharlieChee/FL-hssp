#!/usr/bin/env python3
"""
Adam+Clamp vs HLCP+GIA on CIFAR-100, bs=10 and bs=20, distinct labels, no pool.
"""
...
OUTDIR = "expdata/gia_clamp_vs_hlcp"
...
for data_batch, target_batch in train_loader:
    for i in range(data_batch.shape[0]):
        ...
        if lbl not in collected and lbl < 20:
...
for BS in [10, 20]:
    ...
    print(f"\n{'='*60}")
    print(f"Results (bs={BS}, CIFAR-100, distinct labels, no pool):")
